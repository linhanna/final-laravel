    <div id="header">
        ...
        <div class="header-body">
            <div class="container beta-relative">
                <div class="pull-left">
                    <a href="trangchu" id="logo"><img src="source/assets/dest/images/logo-cake.png" width="200px"
                            alt=""></a>
                </div>
                                ...
                                <div class="beta-dropdown cart-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span class="cart-item-amount">{{ $product['qty'] }}*<span
                                                            id="dongia{{ $product['item']['id'] }}"
                                                            value="@if ($product['item']['promotion_price'] == 0) {{ $product['item']['unit_price'] }}@else {{ $product['item']['promotion_price'] }} @endif">
                                    ...
                                    <div class="cart-caption">
                                        <div class="cart-total text-right">Tổng tiền: <span class="cart-total-value"
                                                value="@if (Session::has('cart')) {{ $totalPrice }}@else 0 @endif">
                                                @if (Session::has('cart'))
                                        ...
                                        <div class="center">
                                            <div class="space10">&nbsp;</div>
                                            <a href="{{ route('dathang') }}" class="beta-btn primary text-center">Đặt
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <div class="cart-item" id="cart-item{{ $productsInWishlist[$i]->id }}">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <span
                                                            class="cart-item-amount">{{ $wishlists[$i]->quantity }}*<span
                                    ...
                                    <div class="dropdown-item">
                                        <div class="cart-caption">
                                            ...
                                            <div class="center">
                                                <div class="space10">&nbsp;</div>
                                                <a href="/wishlist/order" class="beta-btn primary text-center">Đặt
                                                    hàng <i class="fa fa-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
